...
class Camera_reader(object):
    ...
    def build_camera(self):
        ...
        face_cascade = cv2.CascadeClassifier(r"/home/wfy/my_project/gender-keras/data/haarcascade_frontalface_alt.xml")
        #读取dataset数据集下的子文件夹名称
        name_list = read_name_list(r"/home/wfy/my_project/gender-keras/picture/dataset/afterpick")
