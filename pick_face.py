...
def readPicSaveFace(sourcePath,objectPath,*suffix):
    try:
        ...
        count = 1
        face_cascade = cv2.CascadeClassifier('/home/wfy/my_project/facerecognition-attface/data/haarcascade_frontalface_alt.xml')
...
if __name__ == '__main__':
     readPicSaveFace('/home/wfy/faceRecognition-keras/picture/3d','/home/wfy/faceRecognition-keras/picture/pictest','.jpg','.JPG','png','PNG')
