...
#建立一个基于CNN的人脸识别模型
class Model(object):
    FILE_PATH = "/home/wfy/my_project/gender-keras/data/model.h5"   #模型进行存储和读取的地方
    ...
    def train_model(self):
        ...
        self.model.fit(self.dataset.X_train,self.dataset.Y_train,epochs=10,batch_size=30)
...
if __name__ == '__main__':
    dataset = DataSet('/home/wfy/my_project/gender-keras/picture/dataset/afterpick')
    model = Model()
